...
//     currentDay === 'Friday';
//   if (isMyday && !isHoliday && hasMeeting) {
//     return 'You have meeting!';
//   } else {
//     return 'You do not have meeting!';
//   }
// }

// console.log(task40('Wednesday', true, false));
...
// function task41(itemPrice, isDiscount, discountAmount) {
//   if (itemPrice > 1000 && isDiscount && discountAmount >= 10) {
//     return 'Discount is available';
//   } else {
//     return 'Discount is not available';
//   }
...
// console.log(task41(999, false, 10));
...
// function task44(fruit) {
//   if (fruit === 'Lemon' || fruit === 'Orange' || fruit === 'Grapefruit') {
//     return 'Cytrus';
//   } else if (fruit === 'Apple') {
//     return 'Apple';
...
//     return 'Berry';
//   } else {
//     return 'Unfamiliar thing';
//   }
// }

// console.log(task44('apple'));
